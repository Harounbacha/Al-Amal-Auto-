...
// Local Reveal component for animations
    ...
    return (
        <section id="contact" className="py-32 bg-emerald-900 text-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 relative z-10">
                ...
                {/* Form */}
                <Reveal delay={300}>
                    <form className="bg-white p-10 lg:p-12 shadow-2xl border-t-4 border-gold-500 relative text-emerald-950">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                            <div className="space-y-2">
                                <label className="text-[0.65rem] font-bold text-emerald-900 uppercase tracking-widest">{t.contact.name}</label>
                                <input type="text" className="w-full p-4 bg-stone-50 border-b-2 border-stone-200 focus:border-gold-500 outline-none transition-colors text-emerald-950 placeholder-stone-300" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-[0.65rem] font-bold text-emerald-900 uppercase tracking-widest">{t.contact.phone}</label>
                                <input type="tel" className="w-full p-4 bg-stone-50 border-b-2 border-stone-200 focus:border-gold-500 outline-none transition-colors text-emerald-950 placeholder-stone-300" />
                            </div>
                        </div>
                        <div className="space-y-2 mb-8">
                            <label className="text-[0.65rem] font-bold text-emerald-900 uppercase tracking-widest">{t.contact.email}</label>
                            <input type="email" className="w-full p-4 bg-stone-50 border-b-2 border-stone-200 focus:border-gold-500 outline-none transition-colors text-emerald-950 placeholder-stone-300" />
                        </div>
                        <div className="space-y-2 mb-10">
                            <label className="text-[0.65rem] font-bold text-emerald-900 uppercase tracking-widest">{t.contact.message}</label>
                            <textarea rows="3" className="w-full p-4 bg-stone-50 border-b-2 border-stone-200 focus:border-gold-500 outline-none transition-colors text-emerald-950 placeholder-stone-300"></textarea>
                        </div>
